...
class Player:
    ...
    def attack(self,enemy):
        ...
        #they need to go to school
            ...
            print("you can't spell, you lose a turn\n ps go to school")
...
while True:
    ...
    #look around
        ...
        #checks for room_items in map pos
        if "room_items" in map[player.position].keys():
            
            #tells the player the items
